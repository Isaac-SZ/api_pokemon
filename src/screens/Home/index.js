...
const styles = StyleSheet.create({
    ...
    topoTitulo: { fontSize: 22, marginBottom: -2, color: '#000', textAlign: 'center'},
  
    cardContainer: { borderWidth: 1, borderColor: '#d5d5d5', borderRadius: 4, marginBottom: 20, marginHorizontal: 20, padding: 10 },
